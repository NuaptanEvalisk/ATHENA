...
<\body>
  <tmdoc-title|More context dependent interface (1.0.7.8)>

  The interface of the new version of <TeXmacs> is more context dependent. On
  the one hand, the menus and toolbars have been reorganized. Several items
  from the <menu|Insert> menu have been moved to the <menu|Format> menu,
  whereas the context dependent menus <menu|Text>, <menu|Mathematics>,
  <menu|Table>, <menu|Session>, <abbr|etc.> have disappeared, their contents
  being moved to the <menu|Insert> menu.

  On the other hand, a new top-level <menu|Focus> menu has been created. Its
