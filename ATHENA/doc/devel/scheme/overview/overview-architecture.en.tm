...
<\body>
  ...
  <verbatim| \ \ \ $ATHENA_PATH/progs/kernel<new-line>
  \ \ \ $ATHENA_PATH/progs/utils>
  ...
  Whereas the modules in <verbatim|$ATHENA_PATH/progs/kernel> are
  automatically loaded, all modules in <verbatim|$ATHENA_PATH/progs/utils>
  ...
  <verbatim| \ \ \ $ATHENA_PATH/progs/source<new-line>
  \ \ \ $ATHENA_PATH/progs/math<new-line> \ \ \ $ATHENA_PATH/progs/table>
