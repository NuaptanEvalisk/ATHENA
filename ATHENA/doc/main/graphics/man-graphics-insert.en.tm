...
<\body>
  ...
  <icon|tm_point_mode>, <icon|tm_line_mode>,
  <icon|tm_cline_mode>, <icon|tm_spline_mode>,
  <icon|tm_cspline_mode>, <icon|tm_arc_mode>,
  <icon|tm_carc_mode>, <icon|tm_textat_mode>, <icon|tm_math> on
  ...
  <\description>
    <item*|Points>When selecting point mode using <icon|tm_point_mode> or
    <menu|Insert|Point>, you may insert simple points with the left mouse
    button.

    <item*|Lines and polygons>When selecting line mode using
    <icon|tm_line_mode> or <menu|Insert|Line>, you may insert a new
    ...
    mode (<icon|tm_cline_mode> or <menu|Insert|Polygon>) is a variant of
    ...
    <icon|tm_spline_mode> or <menu|Insert|Spline>. This mode is similar
    to line mode, except that we now draw a smooth curve through the
    specified points. Again, this mode admits a closed variant
    (<icon|tm_cspline_mode> or <menu|Insert|Closed spline>).

    <item*|Arcs and circles>Arc mode is selected using <icon|tm_arc_mode>
    ...
    circle mode (<icon|tm_carc_mode> or <menu|Insert|Circle>) for drawing
    circles.

    <item*|Text and mathematics>When selecting text mode
    (<icon|tm_textat_mode> or <menu|Insert|Text>) or mathematics mode
    (<icon|tm_math> or <menu|Insert|Mathematics>), you may enter text (or
