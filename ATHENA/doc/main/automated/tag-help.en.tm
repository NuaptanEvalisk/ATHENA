...
<\body>
  ...
  t))>>
    <\unfolded-documentation|Structured variants>
      ...
      <\block-if|<implied-scm|(numbered-context? t)>>
        ...
        <menu|Focus|Numbered>, or by pressing the <icon|tm_numbered> icon
      ...
      <\block-if|<implied-scm|(alternate-context? t)>>
        <\block-if|<implied-scm|(alternate-first? t)>>
          ...
          <icon|tm_alternate_first> icon on the focus toolbar.
        </block-if>
  ...
  <\block-if|<implied-scm|(focus-has-preferences? t)>>
    <\unfolded-documentation|Style preferences>
      ...
      menu (or in the equivalent <icon|tm_focus_prefs> icon menu on the
  ...
  (any-table-tag? tag))>>
    <\unfolded-documentation|Structured insert and delete>
      ...
      <\description-long>
        ...
        <icon|tm_insert_left>>Insert a new column on the left-hand side
        of the cursor.

        <item*|<shortcut|(structured-insert-right)>, <menu|Focus|Insert
        right>, <icon|tm_insert_right>>Insert a new column on the
        right-hand side of the cursor.

        <item*|<shortcut|(structured-insert-up)>, <menu|Focus|Insert above>,
        <icon|tm_insert_up>>Insert a new row above the cursor.

        <item*|<shortcut|(structured-insert-down)>, <menu|Focus|Insert
        below>, <icon|tm_insert_down>>Insert a new row below the cursor.
      </description-long>
      ...
      <\description-long>
        ...
        leftwards>, <icon|tm_delete_left>>Remove the column at the
        left-hand side of the cursor.

        <item*|<shortcut|(structured-remove-right)>, <menu|Focus|Remove
        rightwards>, <icon|tm_delete_right>>Remove the current column and
        move to the next one.

        <item*|<menu|Focus|Remove upwards>, <icon|tm_delete_up>>Remove
        ...
        <\unfolded-documentation|Structured insert and delete>
          ...
          <\block-texmacs-tag|description-long>
            <\block-if|<implied-scm|(structured-horizontal? t)>>
              ...
              <menu|Focus|Insert left>, <icon|tm_insert_left>>Insert a
              new argument at the left-hand side of the cursor.

              <inline-texmacs-tag|item*|<shortcut|(structured-insert-right)>,
              <menu|Focus|Insert right>, <icon|tm_insert_right>>Insert a
            ...
            <\block-if|<implied-scm|(structured-vertical? t)>>
              ...
              <menu|Focus|Insert above>, <icon|tm_insert_up>>Insert a new
              argument above the cursor.

              <inline-texmacs-tag|item*|<shortcut|(structured-insert-down)>,
              <menu|Focus|Insert below>, <icon|tm_insert_down>>Insert a
          ...
          <\block-texmacs-tag|description-long>
            <\block-if|<implied-scm|(structured-horizontal? t)>>
              ...
              <menu|Focus|Remove leftwards>, <icon|tm_delete_left>>Remove
              ...
              <icon|tm_delete_right>>Remove the current argument and move
              to the next one.
            </block-if>

            <\block-if|<implied-scm|(structured-vertical? t)>>
              <inline-texmacs-tag|item*|<menu|Focus|Remove upwards>,
              <icon|tm_delete_up>>Remove the argument above the cursor.

              <inline-texmacs-tag|item*|<menu|Focus|Remove downwards>,
              <icon|tm_delete_down>>Remove the current argument and move
              to the one below.
            </block-if>
          </block-texmacs-tag>
        </unfolded-documentation>
  ...
  n)>>
    <\unfolded-documentation|Hidden arguments>
      ...
      hidden> or push the <icon|tm_show_hidden> icon on the focus
