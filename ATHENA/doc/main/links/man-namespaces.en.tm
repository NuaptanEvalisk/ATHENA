...
<\body>
  ...
  A website definition has a name, a selector, a destination folder, an
  entrypoint, an optional post-generation command, and a regeneration mode. The
  selector is built visually from recursive path selectors, recursive namespace
  selectors, and boolean operators such as <verbatim|and>, <verbatim|or>,
  <verbatim|xor>, <verbatim|nand>, <verbatim|nor>, and <verbatim|not>. Empty
  ...
  Transclusions are inlined during export.
