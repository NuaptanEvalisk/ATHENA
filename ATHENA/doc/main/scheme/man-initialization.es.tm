...
<\body>
  ...
  <verbatim|$ATHENA_PATH/progs/init-texmacs.scm>, a menos que usted haya
  especificado su propio archivo de inicialización en
  <verbatim|$ATHENA_HOME_PATH/progs/my-init-texmacs.scm>. Pro defecto, la
  ruta <verbatim|$ATHENA_HOME_PATH> iguala a <verbatim|.TeXmacs>.
  ...
  <verbatim|$ATHENA_PATH/progs/init-buffer.scm> es ejecutado, cada vez que
  usted crea un nuevo <em|buffer>, a menos que usted provea su propio archivo
  de inicialización <verbatim|$ATHENA_HOME_PATH/progs/my-init-buffer.scm>
