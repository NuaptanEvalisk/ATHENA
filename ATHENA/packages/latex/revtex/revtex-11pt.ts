...
<\body>
  <active*|<\src-title>
    <src-package|revtex-11pt|1.0>

    <\src-purpose>
      Macros defining sizes for a 11pt Revtex document.
    </src-purpose>
  ...
  <assign|tex-text-width|<macro|468pt>>

  <assign|tex-top-margin|<macro|-37pt>>

  <assign|tex-head-height|<macro|12pt>>

  <assign|tex-top-skip|<macro|10pt>>

  <assign|tex-text-height|<macro|665.5pt>>
