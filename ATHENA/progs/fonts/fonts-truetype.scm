...
(set-font-rules
  `(((luxi tt bold slanted $s $d) (truetype luximbi $s $d))
    ...
    ((bonum ss $a $b $s $d) (heros rm $a $b $s $d))
    ((bonum tt $a $b $s $d) (cursor rm $a $b $s $d))
    ...
    ((pagella ss $a $b $s $d) (heros rm $a $b $s $d))
    ((pagella tt $a $b $s $d) (cursor rm $a $b $s $d))
    ...
    ((schola ss $a $b $s $d) (heros rm $a $b $s $d))
    ((schola tt $a $b $s $d) (cursor rm $a $b $s $d))
    ...
    ((termes ss $a $b $s $d) (heros rm $a $b $s $d))
    ((termes tt $a $b $s $d) (cursor rm $a $b $s $d))
...
(set-font-rules
  '(((cursor $v bold italic $s $d) (unicode texgyrecursor-bolditalic $s $d))
    ((cursor $v bold $b $s $d) (unicode texgyrecursor-bold $s $d))
    ((cursor $v $a italic $s $d) (unicode texgyrecursor-italic $s $d))
    ((cursor $v $a $b $s $d) (unicode texgyrecursor-regular $s $d))

    ((heros $v bold italic $s $d) (unicode texgyreheros-bolditalic $s $d))
    ((heros $v bold $b $s $d) (unicode texgyreheros-bold $s $d))
    ((heros $v $a italic $s $d) (unicode texgyreheros-italic $s $d))
    ((heros $v $a $b $s $d) (unicode texgyreheros-regular $s $d))

    ((adventor $v bold italic $s $d) (unicode texgyreadventor-bolditalic $s $d))
    ((adventor $v bold $b $s $d) (unicode texgyreadventor-bold $s $d))
    ((adventor $v $a italic $s $d) (unicode texgyreadventor-italic $s $d))
    ((adventor $v $a $b $s $d) (unicode texgyreadventor-regular $s $d))

    ;; The historical roman profile keeps its Computer Modern lineage through
    ;; the scalable Latin Modern family.  Smart-font resolution supplies STIX
    ;; and Fira fallbacks on systems where Latin Modern is unavailable.
    ((roman mr $a $b $s $d) (math-latin-modern rm $a $b $s $d))
    ((roman ms $a $b $s $d) (math-latin-modern ss $a $b $s $d))
    ((roman mt $a $b $s $d) (math-latin-modern tt $a $b $s $d))
    ((roman tt bold italic $s $d) (unicode lmmono10-italic $s $d))
    ((roman tt $a italic $s $d) (unicode lmmono10-italic $s $d))
    ((roman tt $a $b $s $d) (unicode lmmono10-regular $s $d))
    ((roman ss bold italic $s $d) (unicode lmsans10-boldoblique $s $d))
    ((roman ss bold $b $s $d) (unicode lmsans10-bold $s $d))
    ((roman ss $a italic $s $d) (unicode lmsans10-oblique $s $d))
    ((roman ss $a $b $s $d) (unicode lmsans10-regular $s $d))
    ((roman rm bold italic $s $d) (unicode lmroman10-bolditalic $s $d))
    ((roman rm bold $b $s $d) (unicode lmroman10-bold $s $d))
    ((roman rm $a italic $s $d) (unicode lmroman10-italic $s $d))
    ((roman rm $a $b $s $d) (unicode lmroman10-regular $s $d))
    ((roman $v $a $b $s $d) (roman rm $a $b $s $d))

    ;; Preserve familiar family names using their TeX Gyre OpenType successors.
    ((avant-garde $v $a $b $s $d) (adventor $v $a $b $s $d))
    ((bookman $v $a $b $s $d) (bonum $v $a $b $s $d))
    ((courier $v $a $b $s $d) (cursor $v $a $b $s $d))
    ((helvetica $v $a $b $s $d) (heros $v $a $b $s $d))
    ((new-century-schoolbook $v $a $b $s $d) (schola $v $a $b $s $d))
    ((palatino $v $a $b $s $d) (pagella $v $a $b $s $d))
    ((times $v $a $b $s $d) (termes $v $a $b $s $d))))
