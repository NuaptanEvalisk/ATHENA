...
(tm-menu (graphics-global-icons)
  (=> (balloon (icon "tm_graphics_geometry") "Graphics geometry")
      (link graphics-global-menu))
  (=> (balloon (icon "tm_graphics_grid") "Graphics grids")
      (link graphics-grids-menu))
  (assuming (inside? 'screens)
    (=> (balloon (icon "tm_overlays") "Graphical slides and overlays")
        (group "Slides")
