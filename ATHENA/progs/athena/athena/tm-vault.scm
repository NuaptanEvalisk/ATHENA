...
(define-preferences
  ...
  ("vault namespace explorer leaf matches only" "off" noop)
  ("vault simplify hierarchy graphs" "off" noop)
  ("vault max full backups" "Unlimited" noop)
  ("vault pre-save history preservation" "1 week" noop)
  ("vault collect orphan assets" "off" noop)
  ("vault subproduct consume string aggressively" "on" noop)
