...
(tm-menu (document-standard-page-formats)
  ...
  (-> "Arch series"
      ("Arch A" (init-page-type "archA"))
      ("Arch B" (init-page-type "archB"))
      ("Arch C" (init-page-type "archC"))
      ("Arch D" (init-page-type "archD"))
      ("Arch E" (init-page-type "archE")))
  (-> "American"
      ("10x14" (init-page-type "10x14"))
      ("11x17" (init-page-type "11x17"))
      ("C5" (init-page-type "C5"))
      ("Comm 10" (init-page-type "Comm10"))
...
(menu-bind page-rendering-menu
  ...
  ("Scroll" (init-page-rendering "papyrus"))
  ("Reflow" (init-page-rendering "automatic"))
  ("Slides" (init-page-rendering "beamer"))
