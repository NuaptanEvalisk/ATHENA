 ...
 * Captures:
 *   a[0], b[0]: course word
 *   a[1], b[1]: extras label
 *   a[2], b[2]: extras number as a Roman numeral
 *
 * As with lec-sorter.c, files for different course words are equal under this
 * sorter. Within the same course, extras are ordered by label and then by Roman
 * number.
 */
