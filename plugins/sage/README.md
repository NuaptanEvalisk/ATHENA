...
``` bash
git clone https://github.com/texmacs/sage.git $HOME/.ATHENA/plugins/sage
```

For Windows:
``` bash
git clone https://github.com/texmacs/sage.git %APPDATA%\ATHENA\plugins\sage
```
...
```
git clone https://gitee.com/texmacs/sage.git %APPDATA%\ATHENA\plugins\sage
```
