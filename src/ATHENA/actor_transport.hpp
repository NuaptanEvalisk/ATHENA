...
enum class actor_command_kind: std::uint32_t {
  ...
  native_ink_stroke,
  native_drawing_recognition,
  native_drawing_transform,
  native_drawing_insert_space,
  native_drawing_trim,
  commutative_diagram_action,
  set_zoom,
  change_zoom,
  zoom_by,
  viewport_changed,
  ...
  ui_focus_view,
  ui_refresh_chrome,
  ui_native_drawing_focus_refresh,
  ui_global_action,
  ui_new_buffer,
  ...
  ui_show_popup,
  ui_close_popup,
  ui_commutative_diagram_popup,
  ui_commutative_diagram_arrow_state,
  ui_show_completion,
  ui_select_completion,
  ui_close_completion,
  ui_set_scrollbars,
  ui_show_header,
  ui_show_icon_bar,
