...
*   - Standard rooted urls, like file:///usr or https://athena.evalisk.org.
...
*     For instance https://athena.evalisk.org/Web * file:///tmp would yield
*     file:///tmp, where as https://athena.evalisk.org/Web * /tmp yields
*     https://athena.evalisk.org/tmp
*******************************************************************************
...
*     Notice that https://athena.evalisk.org/pub and https://athena.evalisk.org/pub/
