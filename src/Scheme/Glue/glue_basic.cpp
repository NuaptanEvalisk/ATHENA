...
tmscm
tmg_ads_show_tool_pane (tmscm arg1, tmscm arg2, tmscm arg3, tmscm arg4, tmscm arg5) {
  ...
  TMSCM_ASSERT_BOOL (arg5, TMSCM_ARG5, "ads-show-tool-pane");
  ...
  // TMSCM_DEFER_INTS;
  ads_show_tool_pane (in1, in2, in3, in4, in5);
  // TMSCM_ALLOW_INTS;
...
tmscm
tmg_aofm_chatgpt_2texmacs (tmscm arg1) {
  TMSCM_ASSERT_STRING (arg1, TMSCM_ARG1, "aofm-chatgpt->texmacs");

  string in1= tmscm_to_string (arg1);

  // TMSCM_DEFER_INTS;
  tree out= aofm_chatgpt_to_tree (in1);
  // TMSCM_ALLOW_INTS;
...
tmscm
tmg_vault_quick_switcher (tmscm arg1) {
  TMSCM_ASSERT_ARRAY_STRING (arg1, TMSCM_ARG1, "vault-quick-switcher");
...
initialize_glue_basic () {
  ...
  tmscm_install_procedure ("ads-show-tool-pane",  tmg_ads_show_tool_pane, 5, 0, 0);
  ...
  tmscm_install_procedure ("aofm-chatgpt->texmacs",  tmg_aofm_chatgpt_2texmacs, 1, 0, 0);
