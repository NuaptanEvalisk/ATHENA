...
bool test (const string& s, int i, const char* test);
bool test (const string& s, int i, const string& test_str);
bool starts (const string& s, const char* test);
bool starts (const string& s, const string& test_str);
bool ends (const string& s, const char* test);
bool ends (const string& s, const string& test_str);
bool read (const string& s, int& i, const char* test);
bool read (const string& s, int& i, const string& test_str);
bool read (const string& s, const string& test_str);
bool read_line (const string& s, int& i, string& result);
bool read_int (const string& s, int& i, int& result);
bool read_double (const string& s, int& i, double& result);
bool read_word (const string& s, int& i, string& result);
bool is_whitespace (const string& s);
void skip_spaces (const string& s, int& i);
void skip_whitespace (const string& s, int& i);
void skip_line (const string& s, int& i);
void skip_symbol (const string& s, int& i);

void parse (const string& s, int& pos, Z8& ret);
void parse (const string& s, int& pos, N8& ret);
void parse (const string& s, int& pos, Z16& ret);
void parse (const string& s, int& pos, N16& ret);
void parse (const string& s, int& pos, Z32& ret);
void parse (const string& s, int& pos, Z32*& a, int len);

int    search_forwards (const string& what, const string& in);
int    search_forwards (const string& what, int pos, const string& in);
int    search_forwards (array<string> what_list, int pos, const string& in);
int    search_backwards (const string& what, const string& in);
int    search_backwards (const string& what, int pos, const string& in);
int    count_occurrences (const string& what, const string& in);
bool   occurs (const string& what, const string& in);
int    overlapping (const string& s1, const string& s2);
string replace (const string& s, const string& what, const string& by);
bool   match_wildcard (const string& s, const string& w);
int    find_non_alpha (const string& s, int pos, bool forward);
array<string> tokenize (const string& s, const string& sep);
string recompose (array<string> a, const string& sep);
string trim_spaces_left (const string& s);
tree   trim_spaces_left (tree t);
array<string> trim_spaces_left (array<string> a);
string trim_spaces_right (const string& s);
...
array<string> strip_completions (array<string> a, const string& prefix);

array<int> differences (const string& s1, const string& s2);
int distance (const string& s1, const string& s2);

void parse_length (const string& s, double& len, string& unit);
