...
enum tree_label {
  ...
  MARK, VAR_MARK, EXPAND_AS,
  EVAL, QUOTE, QUASI, QUASIQUOTE, UNQUOTE, VAR_UNQUOTE, COPY,
  IF, VAR_IF, CASE, DYNAMIC_CASE, WHILE, FOR_EACH,
  ...
  FIND_ACCESSIBLE, HLINK, ACTION, RELAY,
  ...
  // various other tags
  TUPLE, ATTR, TMLEN, COLLECTION, ASSOCIATE, BACKUP, _PATTERN, GRADIENT,
  ...
  PENSCRIPT, CALLIGRAPHY, FILL, IMAGE,
