...
void
editor_rep::schedule_progressive_typeset () {
  if (!progressive_typeset_pending || progressive_typeset_continue) return;
  progressive_typeset_continue= true;
  notify_change (THE_TREE | THE_EXTENTS | THE_FREEZE);
}
